...
urlpatterns = [
    ...
    path("trail/list/<str:pid>",TrailIDView.as_view(),name="trail"),
    ...
    path("participants/points/list/<str:pid>",ParticipantsPointsIDView.as_view(),name="participantspoints"),
    path("visit/list/",VisitView.as_view(),name="visit"),
    path("visit/list/<str:pid>",VisitIDView.as_view(),name="visit"),
