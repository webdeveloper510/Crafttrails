...
urlpatterns = [
    ...
    path('active_user/<str:pid>', ActiveUserId.as_view(), name='activeid_user'),
    path('trail_analytics/', TrailsAnalytics.as_view(), name='trail_analytics'),
    path('trail_analytics/<str:pid>', TrailsAnalyticsId.as_view(), name='trailid_analytics'),
    ...
    path('participant_age/<str:pid>', ParticipantAgeId.as_view(), name='participantid_age'),
    path('participant_gender/', ParticipantGender.as_view(), name='participant_gender'),
    path('participant_gender/<str:pid>', ParticipantGenderId.as_view(), name='participantid_gender'),
    path('usercount/', RegisterUnRegister.as_view(), name='usercount'),
    path('usercount/<str:pid>', RegisterUnRegisterId.as_view(), name='usercountid'),
    path('weekly/', WeeklyParticipants.as_view(), name='weekly'),
    path('weekly/<str:email>', WeeklyParticipantsId.as_view(), name='weeklyid'),
    path('weeklygrowth/', WeeklyGrowth.as_view(), name='weeklygrowth'),
    path('weeklygrowth/<str:email>', WeeklyGrowthId.as_view(), name='weeklygrowthid'),
    path('netchanges/', NetChanges.as_view(), name='netchanges'),
    path('netchanges/<str:email>', NetChangesId.as_view(), name='netchangesid'),
    path('participants/count/', ParticipantsCount.as_view(), name='participants'),
    path('participants/count/<str:pid>', ParticipantsCountId.as_view(), name='participantsid'),
    path('user/links/', FetchLink.as_view(), name='user_links'),
    path('hottest/days/', HottestDay.as_view(), name='hottest_day'),
    path('hottest/days/<str:pid>', HottestDayId.as_view(), name='hottestid_day'),
