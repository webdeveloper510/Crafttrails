...
const BottomAvailable = ({bottomAvailable}) => {
  ...
  const data = bottomAvailable?.slice(firstIndex, lastIndex);
  const nPage = Math.ceil(bottomAvailable?.length / recordPage);
...
export default BottomAvailable;
