...
import { getBreweriesList } from "../../../utils/Api";
        ...
        <div>
          {
            loading ? (
              ...
              <>
                {
                  list && list.length > 0 ? <DynamicTable data={list} moreView={(data) => setOpenModal(data)} /> : "No Record Found!!"
                }
              </>
            )
          }
